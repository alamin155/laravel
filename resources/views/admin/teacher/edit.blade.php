                          ...
                          <form class="forms-sample" method="post" action="{{URL::to('update_teacher/'.$data->id)}}" enctype="multipart/form-data" style="width:100%; font-size: 15px;">
                            ...
                            {{csrf_field()}}
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control p-input" name="teacher_type"
                                  value="{{$data->teacher_type}}" aria-describedby="emailHelp" >
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control p-input" name="teacher_status">
                                  <option @if($data->teacher_status==1) selected @endif value="1">Active</option>
                                  <option @if($data->teacher_status==2) selected @endif value="2">Inactive</option>
                                </select>
                              </div>
                              <div class="form-group">
