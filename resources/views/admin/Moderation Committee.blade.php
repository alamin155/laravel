...
<li class="nav-item">
     ...
     <div class="container col-6 card ml-center">
                          <h2 class="card-title">Moderation Committee Add List</h2>
                          <p class="alert-dark">
                          <?php 
                         ...
                         ?>
                          ...
                          <form class="forms-sample" method="post" action="{{URL::to('/save-moderationcommitee')}}" enctype="multipart/form-data">
                          	{{csrf_field()}}
                             <div class="form-group">
                                  <label for="exampleInputEmail1">Serial No</label>
                                  <input type="text" class="form-control p-input" name="moderationcommittee_sl" aria-describedby="emailHelp" placeholder="Enter Student Name">
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Name</label>
                                  <input type="text" class="form-control p-input" name="moderationcommittee_name" aria-describedby="emailHelp" placeholder="Enter Student Name">
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Designation</label>
                                  <input type="text" class="form-control p-input" name="moderationcommittee_designation" aria-describedby="emailHelp" placeholder="Enter Designation">
                              </div>
                              
                              
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Address</label>
                                  <input type="text" class="form-control p-input" name="moderationcommittee_address" aria-describedby="emailHelp" placeholder="Enter Address">
                              </div>
                             
                              <div class="form-group">
                              	<label for="exampleInputPassword1">Select Remarks</label>
                              	<select class="form-control p-input" name="moderationcommittee_remark">
                              		<option value="1">Chairman</option>
                              		<option value="2">Member</option>
                              		<option value="3">Member(External)</option>
                              	</select>
                              </div>
