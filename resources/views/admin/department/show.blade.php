          ...
          <li class="nav-item">
            ...
            <!--main pages end-->
              ...
              <div class="card-title">
                      <a href="{{URL::to('department/create')}}"><button  class="btn btn-warning btn-sm deleteStudentBtn">Create New Department</button></a> 
                    </div>
                  ...
                  <table  class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td>
                            @if($data->department_status==1) Active @else Inactive @endif</td>
                          </td>
