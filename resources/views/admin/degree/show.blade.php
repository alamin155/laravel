          ...
          <li class="nav-item">
            ...
            <!--main pages end-->
              ...
              <div class="card-title">
                      <a href="{{URL::to('degree/create')}}"><button  class="btn btn-warning btn-sm deleteStudentBtn">Create New Degree</button></a> 
                    </div>
                  ...
                  <table  class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td>{{$data->degree_description}}</td>
                          <td>
                            @if($data->degree_status==1) Active @else Inactive @endif</td>
                          </td>
