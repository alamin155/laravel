          ...
          <li class="nav-item">
            ...
            <!--main pages end-->
              ...
              <div class="card-title">
                      <a href="{{URL::to('/allcourses')}}"><button  class="btn btn-primary btn-sm deleteStudentBtn">Show Courses</button></a> 
                    </div>
                  ...
                  <table  class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td>
                            @if($data->course_status==1) Active @else Inactive @endif</td>
                          </td>
