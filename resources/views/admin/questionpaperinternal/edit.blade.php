...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <form method="post" action=""  id="updatequestionpaperinternalForm">
   @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateModalLabel">Question Paper Setter Internal</h5>
    ...
    <select class="form-control p-input" name="tech" id="up_tech">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary update_questionpaperinternal">Update Question Paper Setter Internal</button>
      </div>
    </div>
  </div>
</form>
