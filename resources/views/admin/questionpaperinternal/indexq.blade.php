...
<li class="nav-item">
     ...
     <div class="container col-6 card-body">
      <div class="col-md-14 card-body" style="width:1000px">
        <h2 class="my-2 text-center">Question Paper Setter Internal</h2>
          <a href="" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New Question Paper Setter Internal</a>
          @foreach($exams as $d)
      ...
      <div class="data-table col-md-10">
            <table class="table table-bordered">
                       ...
                       <td>{{$key=1}}</td>
                       <td>{{$d->teacher->teacher_name}},{{$d->designation}},{{$d->department}} </br>{{$d->address}}</td>
                       <td>
                      <a href="#" class="btn btn-primary update_questionpaperinternal_form" 
                      ...
                      <a href="#" class="btn btn-danger delete_questionpaperinternal" data-id="{{$d->id}}" >
  ...
  @include('admin.questionpaperinternal.modal')
  @include('admin.questionpaperinternal.edit')
  @include('admin.questionpaperinternal.ajaxq')
  {!! Toastr::message() !!}
