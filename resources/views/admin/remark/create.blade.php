...
<li class="nav-item">
     ...
     <div class="container card col-6 ml-center ">
      ...
      <a href="{{URL::to('/allremark')}}">
                                <button class="btn btn-warning btn-sm">Show All Remark List</button>
                              </a>
                          <h2 class="card-title">Remark Add List</h2>
                          
                          <form class="forms-sample" method="post" action="{{URL::to('remark/strore')}}" enctype="multipart/form-data" style="width:100%;font-size: 15px;">
                            {{csrf_field()}}
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Remark Title</label>
                                  <input type="text" class="form-control p-input" name="remark_title" aria-describedby="emailHelp">
                              </div>
